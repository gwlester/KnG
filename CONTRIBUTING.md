...
This repository holds KnG Consulting's own site, Terraform, and content. It
is not currently open to outside contributions — see `LICENSE`.

## Working on this repo

For internal work (human or agent), follow `CLAUDE.md` (mirrored from
...
- Releases (once `Version.MD` and `ReleseNotes/` are in active use) require
  explicit approval before merging a release branch, pushing a tag, or
  publishing a GitHub Release.

## Reporting issues

Use GitHub Issues for bugs or problems with the live site.
